...
public class CommandFurnitureMod extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] arguments) {
		...
		if (arguments[0].matches("version")) {
			...
			sender.sendChatToPlayer(ChatMessageComponent.createFromText("- uf : Universal Furniture"));
			return;
		}
	...
	private void commandVersion(ICommandSender sender, String[] arguments) {
		...
		sender.sendChatToPlayer(ChatMessageComponent.createFromText(String.format(colour + "UniversalFurniture %s for Minecraft %s (Latest: %s).", Version.getVersion(),
